            ...
            <div className="p-6 border-b border-slate-200/50 dark:border-slate-700/50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <h1 className="text-xl font-bold bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300 bg-clip-text text-transparent">AI SDR</h1>
            ...
            <div className="p-4 border-t border-slate-200/50 dark:border-slate-700/50 space-y-3">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="w-full justify-start hover:bg-slate-100/80 dark:hover:bg-slate-800/50 transition-all duration-200 hover:scale-[1.01]">
                    <User className="w-5 h-5 mr-3 text-slate-500 dark:text-slate-400" />
                    <span className="text-sm font-medium">Profile</span>
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" className="w-56 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border-slate-200/50 dark:border-slate-700/50 shadow-xl">
