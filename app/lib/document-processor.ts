...
/**
 * Generate summary of content using GPT-4
 */
  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are a helpful assistant that creates concise summaries of documents for a sales knowledge base. Focus on key points, features, benefits, and use cases.'
        },
        {
          role: 'user',
